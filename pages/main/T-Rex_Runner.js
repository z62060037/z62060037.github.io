  ...
  return (function(A) {
    ...
    function(A, i, t) {
      function s(A, i) {
        for (var t = 0; t < A.length; t++) {
          ...
          if (e) {
            ...
            for (var o = [], n = 0; n < s.parts.length; n++)
              o.push(r(s.parts[n], i));
      ...
      function n(A, i) {
        ...
        if ("top" === A.insertAt)
          s
            ? s.nextSibling
              ? t.insertBefore(i, s.nextSibling)
              : t.appendChild(i)
      ...
      function d(A, i) {
        ...
        s &&
          (t +=
            ...
            " */");
        var e = new Blob([t], { type: "text/css" }),
          n = A.href;
    ...
    function(A, i) {
      ...
      function n(A, i, s, e) {
        ...
        return (
          (n.className = e ? t.classes.CANVAS + " " + e : t.classes.CANVAS),
          (n.width = i),
          (n.height = s),
          A.appendChild(n),
          n
      ...
      function r(A, i, s) {
        var e = (t.defaultDimensions.WIDTH + A.xPos,
          new I(
            i.xPos + 1,
            i.yPos + 1,
            i.config.WIDTH - 2,
          ...
          n = new I(
            A.xPos + 1,
            A.yPos + 1,
            A.typeConfig.width * A.size - 2,
            A.typeConfig.height - 2
          );
        if ((s && g(s, e, n), d(e, n)))
          for (
            var o = A.collisionBoxes,
              h = i.ducking
      ...
      (t.config = {
        ...
        (t.defaultDimensions = { WIDTH: S, HEIGHT: 150 }),
        (t.classes = {
        ...
        (t.prototype = {
          updateConfigSetting: function(A, i) {
            if (A in this.config && void 0 != i)
              switch (((this.config[A] = i), A)) {
                case "GRAVITY":
          ...
          loadImages: function() {
            Q
              ? ((t.imageSprite = document.getElementById(
              ...
              : ((t.imageSprite = document.getElementById(
                ...
                (this.spriteDef = t.spriteDefinition.LDPI)),
              this.init();
          },
          loadSounds: function() {
            if (!T && window.AudioContext) {
              this.audioContext = new AudioContext();
              var A = document.getElementById(this.config.RESOURCE_TEMPLATE_ID)
                .content;
          ...
          update: function() {
            ...
            if (((this.time = A), this.activated)) {
              ...
              if (
                (e && this.playSound(this.soundFx.SCORE),
                ...
                n > 0 &&
                  ((this.invertTrigger = !(n % this.config.INVERT_DISTANCE)),
                  this.invertTrigger &&
                    0 === this.invertTimer &&
                    ((this.invertTimer += i), this.invert()));
              }
            }
            ...
            document.addEventListener(t.events.KEYDOWN, this),
              ...
              D
                ? (this.touchController.addEventListener(
                  ...
                  this.containerEl.addEventListener(t.events.TOUCHSTART, this))
                : (document.addEventListener(t.events.MOUSEDOWN, this),
                  document.addEventListener(t.events.MOUSEUP, this));
          },
          stopListening: function() {
            document.removeEventListener(t.events.KEYDOWN, this),
              ...
              D
                ...
                : (document.removeEventListener(t.events.MOUSEDOWN, this),
                  document.removeEventListener(t.events.MOUSEUP, this));
          },
          onKeyDown: function(A) {
            D && A.preventDefault(),
              this.crashed ||
                (!t.keycodes.JUMP[A.keyCode] &&
                  A.type != t.events.TOUCHSTART) ||
              ...
              this.crashed &&
                A.type == t.events.TOUCHSTART &&
                A.currentTarget == this.containerEl &&
                this.restart(),
              this.activated &&
                !this.crashed &&
                t.keycodes.DUCK[A.keyCode] &&
                (A.preventDefault(),
                this.tRex.jumping
          ...
          onKeyUp: function(A) {
            var i = String(A.keyCode),
              s =
                t.keycodes.JUMP[i] ||
                A.type == t.events.TOUCHEND ||
                A.type == t.events.MOUSEDOWN;
            if (this.isRunning() && s) this.tRex.endJump();
            else if (t.keycodes.DUCK[i])
              (this.tRex.speedDrop = !1), this.tRex.setDuck(!1);
            else if (this.crashed) {
              var e = h() - this.time;
              (t.keycodes.RESTART[i] ||
                this.isLeftClickOnCanvas(A) ||
                (e >= this.config.GAMEOVER_CLEAR_TIME && t.keycodes.JUMP[i])) &&
                this.restart();
          ...
          isLeftClickOnCanvas: function(A) {
            return (
              null != A.button &&
              A.button < 2 &&
              A.type == t.events.MOUSEUP &&
              A.target == this.canvas
            );
          },
          raq: function() {
            this.drawPending ||
          ...
          play: function() {
            this.crashed ||
              ((this.activated = !0),
              (this.paused = !1),
              this.tRex.update(0, u.status.RUNNING),
              (this.time = h()),
              this.update());
          },
          restart: function() {
            this.raqId ||
              ...
              (this.time = h()),
              this.containerEl.classList.remove(t.classes.CRASHED),
              this.clearCanvas(),
          ...
          invert: function(A) {
            A
              ? (document.body.classList.toggle(t.classes.INVERTED, !1),
                (this.invertTimer = 0),
                (this.inverted = !1))
        ...
        (E.prototype = {
          init: function(A) {
            if (
              ...
              this.size > 1 &&
                this.typeConfig.multipleSpeed > A &&
                (this.size = 1),
          ...
          draw: function() {
            ...
            Q && ((A = 2 * A), (i = 2 * i));
            var s = A * this.size * (0.5 * (this.size - 1)) + this.spritePos.x;
          ...
          update: function(A, i) {
            this.remove ||
              ...
              (this.xPos -= Math.floor(i * V / 1e3 * A)),
          ...
          cloneCollisionBoxes: function() {
            for (
              var A = this.typeConfig.collisionBoxes, i = A.length - 1;
              i >= 0;
              i--
            )
              this.collisionBoxes[i] = new I(
                A[i].x,
                A[i].y,
                A[i].width,
                A[i].height
        ...
        (u.prototype = {
          ...
          update: function(A, i) {
            (this.timer += A),
              i &&
                ((this.status = i),
                (this.currentFrame = 0),
                (this.msPerFrame = u.animFrames[i].msPerFrame),
                (this.currentAnimFrames = u.animFrames[i].frames),
                i == u.status.WAITING &&
                  ((this.animStartTime = h()), this.setBlinkDelay())),
              this.playingIntro &&
                this.xPos < this.config.START_X_POS &&
                (this.xPos += Math.round(
                  this.config.START_X_POS / this.config.INTRO_DURATION * A
                )),
              this.status == u.status.WAITING
                ? this.blink(h())
          ...
          draw: function(A, i) {
            var s = A,
              e = i,
              n =
                this.ducking && this.status != u.status.CRASHED
          ...
          blink: function(A) {
            ...
            i >= this.blinkDelay &&
              (this.draw(this.currentAnimFrames[this.currentFrame], 0),
              1 == this.currentFrame &&
                (this.setBlinkDelay(), (this.animStartTime = A)));
          },
          startJump: function(A) {
            this.jumping ||
              (this.update(0, u.status.JUMPING),
              (this.jumpVelocity = this.config.INIITAL_JUMP_VELOCITY - A / 10),
              (this.jumping = !0),
              (this.reachedMinHeight = !1),
              (this.speedDrop = !1));
          },
          ...
          setDuck: function(A) {
            A && this.status != u.status.DUCKING
              ? (this.update(0, u.status.DUCKING), (this.ducking = !0))
              : this.status == u.status.DUCKING &&
                (this.update(0, u.status.RUNNING), (this.ducking = !1));
          },
          reset: function() {
            (this.yPos = this.groundYPos),
              (this.jumpVelocity = 0),
        ...
        (l.dimensions = { WIDTH: 10, HEIGHT: 13, DEST_WIDTH: 11 }),
        ...
        (l.prototype = {
          init: function(A) {
            ...
            for (var t = 0; t < this.maxScoreUnits; t++)
              this.draw(t, 0), (this.defaultString += "0"), (i += "9");
          ...
          update: function(A, i) {
            ...
            if (this.acheivement)
              ...
              i % this.config.ACHIEVEMENT_DISTANCE == 0 &&
                ((this.acheivement = !0), (this.flashTimer = 0), (s = !0));
            ...
            if (t)
              for (var n = this.digits.length - 1; n >= 0; n--)
                this.draw(n, parseInt(this.digits[n]));
            return this.drawHighScore(), s;
          },
          drawHighScore: function() {
            this.canvasCtx.save(), (this.canvasCtx.globalAlpha = 0.8);
            for (var A = this.highScore.length - 1; A >= 0; A--)
              this.draw(A, parseInt(this.highScore[A], 10), !0);
            this.canvasCtx.restore();
          },
        ...
        (p.prototype = {
          update: function(A, i) {
            if (
              (A &&
                0 == this.opacity &&
                (this.currentPhase++,
                this.currentPhase >= p.phases.length &&
                  (this.currentPhase = 0)),
              A && (this.opacity < 1 || 0 == this.opacity)
                ? (this.opacity += p.config.FADE_SPEED)
                : this.opacity > 0 && (this.opacity -= p.config.FADE_SPEED),
              this.opacity > 0)
            ) {
              if (
                ((this.xPos = this.updateXPos(this.xPos, p.config.MOON_SPEED)),
                this.drawStars)
              )
                for (var t = 0; t < p.config.NUM_STARS; t++)
          ...
          updateXPos: function(A, i) {
            return (
              A < -p.config.WIDTH ? (A = this.containerWidth) : (A -= i), A
            );
          },
          draw: function() {
            var A =
                3 == this.currentPhase ? 2 * p.config.WIDTH : p.config.WIDTH,
              i = p.config.HEIGHT,
            ...
            if (
              (Q &&
                ((A *= 2),
                (i *= 2),
                (s = this.spritePos.x + 2 * p.phases[this.currentPhase]),
                (n *= 2),
                (o = t.spriteDefinition.HDPI.STAR.x)),
              this.canvasCtx.save(),
              (this.canvasCtx.globalAlpha = this.opacity),
              this.drawStars)
            )
              for (var h = 0; h < p.config.NUM_STARS; h++)
                this.canvasCtx.drawImage(
                  t.imageSprite,
                  o,
                  this.stars[h].sourceY,
                  n,
                  n,
                  Math.round(this.stars[h].x),
                  this.stars[h].y,
                  p.config.STAR_SIZE,
                  p.config.STAR_SIZE
                );
          ...
          placeStars: function() {
            for (
              var A = Math.round(this.containerWidth / p.config.NUM_STARS),
                i = 0;
              i < p.config.NUM_STARS;
              i++
            )
              (this.stars[i] = {}),
                ...
                Q
                  ? (this.stars[i].sourceY =
                      t.spriteDefinition.HDPI.STAR.y +
                      2 * p.config.STAR_SIZE * i)
                  : (this.stars[i].sourceY =
                      t.spriteDefinition.LDPI.STAR.y + p.config.STAR_SIZE * i);
          },
          reset: function() {
            (this.currentPhase = 0), (this.opacity = 0), this.update(!1);
          }
        }),
        (m.dimensions = { WIDTH: 600, HEIGHT: 12, YPOS: 127 }),
        (m.prototype = {
          setSourceDimensions: function() {
            for (var A in m.dimensions)
              Q
                ? "YPOS" != A &&
                  (this.sourceDimensions[A] = 2 * m.dimensions[A])
                : (this.sourceDimensions[A] = m.dimensions[A]),
          ...
          updateXPos: function(A, i) {
            ...
            (this.xPos[t] -= i),
              ...
              this.xPos[t] <= -this.dimensions.WIDTH &&
                ((this.xPos[t] += 2 * this.dimensions.WIDTH),
                (this.xPos[s] = this.xPos[t] - this.dimensions.WIDTH),
                (this.sourceXPos[t] = this.getRandomType() + this.spritePos.x));
          },
          update: function(A, i) {
            var t = Math.floor(0.06 * i * A);
        ...
        (f.prototype = {
          ...
          updateClouds: function(A, i) {
            ...
            if (s) {
              ...
              s < this.config.MAX_CLOUDS &&
                this.dimensions.WIDTH - n.xPos > n.cloudGap &&
          ...
          updateObstacles: function(A, i) {
            for (
              var t = this.obstacles.slice(0), s = 0;
              s < this.obstacles.length;
              s++
            ) {
            ...
            if (((this.obstacles = t), this.obstacles.length > 0)) {
              ...
              n &&
                !n.followingObstacleCreated &&
                n.isVisible() &&
                n.xPos + n.width + n.gap < this.dimensions.WIDTH &&
                (this.addNewObstacle(i), (n.followingObstacleCreated = !0));
          ...
          addNewObstacle: function(A) {
            var i = s(0, E.types.length - 1),
              e = E.types[i];
            if (this.duplicateObstacleCheck(e.type) || A < e.minSpeed)
              this.addNewObstacle(A);
            else {
          ...
          addCloud: function() {
            this.clouds.push(
              new C(this.canvas, this.spritePos.CLOUD, this.dimensions.WIDTH)
            );
          }
        });
    }
